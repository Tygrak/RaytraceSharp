...
namespace RaytracerSharp {
    public class Quad : Hittable {
        ...
        public Quad(Vector3 vertex1, Vector3 vertex2, Vector3 vertex3, Vector3 vertex4, Material material) {
            Material = material;
            Vertex1 = vertex1;
            Vertex2 = vertex2;
            Vertex3 = vertex3;
        ...
        public override HitRecord Hit(Ray ray, float t_min, float t_max) {
            RayCollision rayCollision = Raylib.GetRayCollisionQuad(ray, Vertex1, Vertex2, Vertex3, Vertex4);
